 ...
 *
 */
//WHG Dispatcher的作用为维护请求的状态，并维护一个线程池，用于执行请求
//WHG Dispatcher可以理解为生产者， executorService为消费者
public final class Dispatcher {
    ...
    public synchronized ExecutorService executorService() {
        if (executorService == null) {
            //WHG 核心线程数为0,最多线程数是最大
            //WHG SynchronousQueue 同步队列，内部没有容量
            //WHG 实现最大并发
    ...
    //WHG Dispatcher执行异步请求
    synchronized void enqueue(AsyncCall call) {
        //WHG 异步请求最多64(默认)个，同一个host正在请求的个数不能超过5个
