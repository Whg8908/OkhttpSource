...
public final class StreamAllocation {
    ...
    public HttpCodec newStream(
        ...
        try {
            ...
            //WHG 利用连接实例化流HttpCodec对象，如果是HTTP/2返回Http2Codec，否则返回Http1Codec
    ...
    private RealConnection findConnection(int connectTimeout, int readTimeout, int writeTimeout,
        ...
        synchronized (connectionPool) {
            ...
            if (result == null) {
                //WHG 尝试从连接池获取连接，如果有可复用的连接,会给第三个参数 this的connection赋值
        ...
        //WHG 实际上就是创建socket连接，但是要注意的是如果存在http代理的情况
    ...
    public void streamFinished(boolean noNewStreams, HttpCodec codec, long bytesRead,
                               IOException e) {
